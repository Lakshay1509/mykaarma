CREATE TABLE reminder (
    ...
    -- The no-duplicates requirement (section 7.3): a second reminder of the same type can't exist.
...
-- Keep these partial: indexing only PENDING and CLAIMED rows keeps claims fast past 100M rows (section 4).
